...
class Data:
    ...
    def __init__(self, data_set_name=None, path_tij=None, separator_tij=None, path_meta=None, separator_meta=None,
                 meta_attr_list=None, header=None):
        ...
        """Initialize an object that contains Tij- and Metadata for imported or given datasets.
            ...
            path_tij (optional str, default: None)
                Can be used to import tij datasets manually.
            separator_tij (optional str, default: None)
                Must be used if you import tij datasets manually.
            path_meta (optinal str, default: None)
                Can be used to import meta datasets manually.
            separator_meta (optional str, default: None)
                 Must be used if you import meta datasets manually.
            meta_attr_list (optional list, default None)
                Must be used if you want to import a meta dataset manually that has no header.
        ...
        data_set = {"WS16": {"tij": [str(path + "data/WS16/tij_WS16.dat"), "\t"],
                    ...
                    "scc2034": {"tij": [str(path + "data/scc2034/tij_scc2034"), "\t"],
                                "meta": [str(path + "data/scc2034/metadata_scc2034"), "\t"],
                                "attr": {0: "ID", 1: "Household", 2: "Age", 3: "Gender"}},
