...
def calculate_triangle_duration(Data, bins=None):
    r"""Calculates the probabilities for the contact duration between triangle constellations
        ...
        References
        ----------
        .. [2] Cattuto C, Van den Broeck W, Barrat A, Colizza V, Pinton JF, et al. (2010) Dynamics of Person-to-Person Interactions from Distributed RFID Sensor Networks. PLOS ONE
...
def calculate_inter_contact_duration(Data, bins=None):
    r"""Calculates the probabilities for the inter-contact duration
        ...
        .. [3] Cattuto C, Van den Broeck W, Barrat A, Colizza V, Pinton JF, et al. (2010) Dynamics of Person-to-Person Interactions from Distributed RFID Sensor Networks. PLOS ONE
