def check_compatibility_of_versions():
    ...
    """Check installed packages needed for this library
       ...
       See Also
       ---------
       sociopatterns.compatibility_check.check_compatibility.check_which_methods_are_affected
       """
...
def check_which_methods_are_affected(dict):
    ...
    """Check for affected library functions
       ...
       See Also
       ---------
       sociopatterns.compatibility_check.check_compatibility.check_compatibility_of_versions
       """
